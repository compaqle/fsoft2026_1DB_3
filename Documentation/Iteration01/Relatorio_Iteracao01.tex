...
\begin{itemize}
    ...
    \item \textbf{US11:} Como ADMIN, eu quero gerir o registo de CLIENTES (criar/editar/apagar) para manter a base de dados de fidelização atualizada.
    \item \textbf{US15:} Como ADMIN, eu quero criar e gerir PROMOÇÕES (percentagem, data início, data fim) para incentivar as VENDAS.
    \item \textbf{US16:} Como ADMIN, eu quero associar PROMOÇÕES a PRODUTOS específicos ou a CATEGORIAS inteiras para incentivar as VENDAS de PRODUTOS específicos ou CATEGORIAS inteiras.
\end{itemize}

\subsubsection{CAIXA}
\begin{itemize}
    \item \textbf{US07:} Como CAIXA, eu quero listar PRODUTOS e consultar preços para informar os CLIENTES.
    ...
    \item \textbf{US10:} Como CAIXA, eu quero consultar o meu histórico e informação individual para saber o meu desempenho.
    \item \textbf{US12:} Como CAIXA, eu quero associar uma VENDA a um CLIENTE (via NIF ou ID) para que este possa acumular pontos de fidelização.
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{diagramas/domain_model.png}}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lllX}
        ...
        UC15 & Consultar RECIBO & CAIXA & Consultar e visualizar o RECIBO de uma VENDA terminada. \\ \bottomrule
    \end{tabularx}
...
}{3.a. O ADMIN seleciona "Editar": O sistema solicita o ID e novos dados. \newline 3.b. O ADMIN seleciona "Remover": O sistema solicita o ID e confirma a remoção.}{N/A (Happy case assumido).}
...
}{3.a. O ADMIN seleciona "Remover": O sistema solicita o ID do CAIXA e remove a conta.}{N/A}
...
}{6.a. O CAIXA cancela a VENDA: O sistema descarta os dados e liberta o stock reservado.}{N/A}

\subsubsection{UC06: Consultar Preço}
...
\subsubsection{UC07: Consultar Info e Histórico}
\ucspec{CAIXA}{Consultar Info e Histórico}{Exibe dados do utilizador CAIXA e o histórico de VENDAS realizadas.}{CAIXA autenticado no sistema.}{N/A (Consulta).}{
1. O CAIXA solicita o seu histórico. \newline
2. O sistema apresenta os dados do perfil (ID, nome) e o total faturado. \newline
3. O sistema apresenta a lista detalhada das VENDAS efetuadas por ele.
}{N/A}{N/A}

\subsubsection{UC08: Gerir CLIENTES}
...
}{3.a. O ADMIN seleciona "Editar": O sistema permite mudar o nome do CLIENTE. \newline 3.b. O ADMIN seleciona "Remover": O sistema apaga o perfil do CLIENTE.}{N/A}

\subsubsection{UC09: Associar CLIENTE}
...
\subsubsection{UC10: Consultar Pontos do CLIENTE}
\ucspec{CAIXA}{Consultar Pontos do CLIENTE}{Permite visualizar o saldo de pontos atual de um CLIENTE.}{CAIXA autenticado no sistema.}{N/A (Consulta).}{
...
\subsubsection{UC11: Gerir PROMOÇÕES}
...
}{3.a. O ADMIN seleciona "Remover": O sistema apaga a regra de promoção selecionada.}{N/A}

\subsubsection{UC12: Gerir CATEGORIAS}
...
\subsubsection{UC13: Selecionar Perfil}
...
\subsubsection{UC14: Sair do Perfil}
...
\subsubsection{UC15: Consultar RECIBO}
...
}{N/A (Happy case assumido).}{N/A (Happy case assumido).}
...
\begin{description}
    \item[ADMINISTRAÇÃO] Papel de gestão e controlo total das operações do sistema.
