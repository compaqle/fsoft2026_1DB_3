...
Nesta secção, por motivos de concisão, são apresentados apenas os Diagramas de Sequência de Sistema (SSD) mais representativos e complexos do sistema. Os diagramas referentes a consultas simples (ex: Consultar Preço, Consultar Pontos) foram omitidos deste documento, embora estejam mapeados no repositório de projeto.
