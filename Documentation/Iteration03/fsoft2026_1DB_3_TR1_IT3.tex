...
No total, o sistema final conta com 10 classes de domínio (Model), 6 classes de interface (View), 6 Services, 1 Repository com padrão Singleton, 7 DTOs, 6 Mappers e 4 classes de exceção. A arquitetura em camadas (View $\rightarrow$ Controller $\rightarrow$ Service $\rightarrow$ Repository) manteve-se consistente ao longo de todo o desenvolvimento, assegurando uma separação clara de responsabilidades.
